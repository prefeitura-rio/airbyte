...
import pytest
from source_couchdb.source import CouchdbStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(CouchdbStream, "path", "v0/example_endpoint")
    mocker.patch.object(CouchdbStream, "primary_key", "test_primary_key")
    mocker.patch.object(CouchdbStream, "__abstractmethods__", set())
